...
> 자세한 라이선스 정보는 [FFmpeg License and Legal Considerations](https://www.ffmpeg.org/legal.html) 참고
...
이 중 `ffmpeg` 도구를 기준으로 FFmpeg 명령어 사용 방법을 알아보자.
...
> 자세한 옵션 정보는 [FFmpeg 공식 문서](https://www.ffmpeg.org/ffmpeg-all.html) 참고
