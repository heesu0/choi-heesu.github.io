...
다른 객체 초기화 방식이 사용할 수 없는 경우에도 uniform initialization은 말 그대로 어디서나 사용할 수 있다.
...
most vexing parse로 인해 `()`를 사용하여 객체를 초기화하면 함수 정의와 혼돈이 발생하는데 중괄호 초기화를 통해 해결할 수 있다.
